...
//           Logger.i(e.getMessage());
    ...
    public static int getScreenWidth() {
        return getDisplayMetrics(ResProvider.application()).widthPixels;
    }
    ...
    public static int getScreenHeight() {
        return getDisplayMetrics(ResProvider.application()).heightPixels;
    }
    ...
    public static float getDensity() {
        return getDisplayMetrics(ResProvider.application()).density;
    }
    ...
    public static int getDensityDpi() {
        return getDisplayMetrics(ResProvider.application()).densityDpi;
    }
...
//            Logger.e(String.valueOf(e.getMessage()));
    ...
    public static String getNetworkOperatorName() {
        try {
            TelephonyManager tm = (TelephonyManager)ResProvider.application()
