...
//        wxLoginService = new WXLoginService(context, btn_wxlogin);
    ...
    public void initAccountRegisterService(Context context, String mUserName, String pwd) {
        tlsService.TLSStrAccReg(mUserName, pwd, new TLSStrAccRegListener() {
            @Override
            public void OnStrAccRegSuccess(TLSUserInfo tlsUserInfo) {
                Log.e("msc", "OnStrAccRegSuccess");
            }

            @Override
            public void OnStrAccRegFail(TLSErrInfo tlsErrInfo) {
                Log.e("msc", "OnStrAccRegFail " + tlsErrInfo.Msg);
            }

            @Override
            public void OnStrAccRegTimeout(TLSErrInfo tlsErrInfo) {
                Log.e("msc", "OnStrAccRegTimeout");
            }
        });
    }
